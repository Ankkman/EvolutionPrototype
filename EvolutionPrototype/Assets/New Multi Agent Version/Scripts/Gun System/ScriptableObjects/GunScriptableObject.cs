...
public class GunScriptableObject : ScriptableObject
{
    ...
    {
        if (muzzleTransform == null || activeMonoBehaviour == null || ShootConfig == null || TrailConfig == null || trailPool == null)
            return;
    ...
    private IEnumerator PlayTrail(Vector3 startPoint, Vector3 endPoint, RaycastHit hit)
    {
            ...
            if (hit.collider != null)
            {
                ...
                if (health != null)
                {
                    AgentIdentity attacker = activeMonoBehaviour != null ? activeMonoBehaviour.GetComponent<AgentIdentity>() : null;
                    ...
                    if (!wasDeadBefore && health.Model.IsDead && MetricsLogger.Instance != null && attacker != null && victim != null)
